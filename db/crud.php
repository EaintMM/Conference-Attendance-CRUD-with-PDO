<?php
    class crud{
        ...
        // insert the attendee
        public function insertAttendee($fname,$lname,$dob,$email,$phone,$expertise,$avatar_path){
            try{
                // define sql statement to be executed
                $sql = "INSERT INTO attendee(firstname,lastname,dateofbirth,email,phone,expertise_id,avatar_path) VALUES(:fname,:lname,:dob,:email,:phone,:expertise, :avatar_path)";
